...
<body>
  ...
  window.addEventListener("DOMContentLoaded", function() {
    ...
    iframeMapa.src = "https://www.google.com/maps/d/embed?mid=1Yu6mBBLQ_U0ixGw3f8vbxbE6O83HMVs&hl=es-419&ehbc=2E312F";
    iframeMapa.width = "940";
    iframeMapa.height = "680";
    iframeMapa.style.display = "block";
    iframeMapa.style.margin = "0 auto";

    divMapa.appendChild(iframeMapa);
  });
</script>
